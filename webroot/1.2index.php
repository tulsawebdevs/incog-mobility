 ...
 */
	if (!defined('ROOT')) {
		...
		$m = strstr($_SERVER['HTTP_HOST'],"lint") 
		? "mcrouch2"
		: "innerecho";
    define('ROOT', DS.'home'.DS.$m.DS.'workspace');
	}
    if (!defined('APP_DIR')) {
		define('APP_DIR', "interformApp") ;       
    }
/**
 ...
 */
	if (!defined('CAKE_CORE_INCLUDE_PATH')) {
		...
		//You should also use the DS define to separate your directories
    define('CAKE_CORE_INCLUDE_PATH', DS.'usr'.DS.'lib'.DS.'cake'.DS.'1.3');
	}
...
define('PHOTO','photoes/');
define('PHOTO_WIDTH',181);
define('PHOTO_HEIGHT',240);
define('CURRICULUM_DEFAULT',1);
define('CMS_WRITER','CMS-Writer.pdf');
define('CMS_EDITOR','CMS-Editor.pdf');
